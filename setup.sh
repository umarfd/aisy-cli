...
echo "Updating package index and installing dependencies (python3, openssh-client, traceroute)..."
apt-get update -y
apt-get install -y python3 openssh-client traceroute >/dev/null 2>&1 || {
